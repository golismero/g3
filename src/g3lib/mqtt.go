...
type G3Scan struct {            // MessageType: MSG_SCAN
	...
	Report *g3.ReportStatement  `json:"report,omitempty"`
}
...
func SendNewScan(client MessageQueueClient, scanid, mode string, pipelines [][]string, report *g3.ReportStatement) error {
	msg := G3Scan{}
